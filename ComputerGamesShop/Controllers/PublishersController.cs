...
namespace ComputerGamesShop.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(ComputerGamesShopContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Image,FoundedDate,Specialty")] Publisher publisher)
        {
            if (id != publisher.ID)
            {
                return NotFound();
