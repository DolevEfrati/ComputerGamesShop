...
namespace ComputerGamesShop.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(ComputerGamesShopContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,FirstName,LastName,BirthDate,Gender,Email,Password,City,Street,PhoneNumber,Role")] User user)
        {
            if (id != user.UserID)
            {
                return NotFound();
